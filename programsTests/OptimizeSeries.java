...
public class OptimizeSeries extends MeshiProgram implements KeyWords {
    private enum TETHER_FLAG {ON, OFF, RESET_ON, RESET_OFF}
    private enum SUMMA_COOP_FLAG {ON, OFF}
    private enum RAMACH_COOP_FLAG {ON, OFF}
    private enum PROP_COOP_FLAG {ON, OFF}
    private enum RG_FLAG {ON, OFF}
    private enum SOLVATE_FLAG{ON, OFF}


    public static final String NAME = "OptimizeSeries";
    ...
    private static EnergyCreator[] energyCreators = {new DistanceConstraintsCreator(),            new BondCreator(),            new AngleCreator(),            planeCreator,            new OutOfPlaneCreator(),            //excludedVolCreator,
            ramachandranCreator,
            ramachCreator,            cooperativeZRamachandranCreator,            cooperativeZStdRamachandranCreator,            ramachandranCoreCreator,            propensityCreator,            cooperativeZPropensityCreator,            cooperativeZStdPropensityCreator,
            summaCreator,            excludedVolCreator,            cooperativeZSummaCreator,            cooperativeZStdSummaCreator,            solvationCreator,            atomEnvironmentCreator,            atomEnvironmentCreatorSS,
            solvateCreator,            hydrogenBondsCreator,            hydrogenBondsPairsCreator,            new HbondsPunishHOCAngleCreator(hydrogenBondsCreator),            new HBondsPunishOHNAngleCreator(hydrogenBondsCreator),            contactsCreator,
            rgCreator,
            //goapCreator,
            conservationContactsCreator8,            conservationContactsCreator11,            conservationContactsCreator15,            conservationContactsHrCreator,
            inflateCreator,            inflatePerSegmentCreator,            inflateBySegmentCreator,            inflateByOtherModelCreator,            residueTetherCreator,            flatRamachCreator,
            tetherAllCreator,		    rapdfCreator,            new StaticFeaturesCreator(),
            //new SecondaryStructureAlphabetFeatures_plusNoiseCreator(),
            //new DeepCNF_ssCompatibilityFeatureCreator()
    };

    private static EnergyCreator[] excludeFromMinimization = {inflateCreator, inflatePerSegmentCreator,            inflateBySegmentCreator, inflateByOtherModelCreator, ramachandranCreator};       // inflate is noise  and the other two have almost arbitrary values.
    private static EnergyCreator[] excludeFromPerturbation1 = {tetherAllCreator, residueTetherCreator, inflatePerSegmentCreator, inflateBySegmentCreator,                                                               inflateByOtherModelCreator, rapdfCreator,ramachandranCoreCreator};
    private static EnergyCreator[] excludeFromPerturbation2 = {tetherAllCreator, residueTetherCreator, inflateCreator, inflateBySegmentCreator, inflateByOtherModelCreator , rapdfCreator, ramachandranCoreCreator};
    private static EnergyCreator[] excludeFromPerturbation3 = {tetherAllCreator, residueTetherCreator, inflateCreator, inflatePerSegmentCreator, inflateByOtherModelCreator , rapdfCreator, ramachandranCoreCreator};
    private static EnergyCreator[] excludeFromPerturbation4 = {tetherAllCreator, residueTetherCreator, inflateCreator, inflatePerSegmentCreator, inflateBySegmentCreator, rapdfCreator, ramachandranCoreCreator};
