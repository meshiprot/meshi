 ...
 */
public class MeshiScore2 extends MeshiProgram implements KeyWords {
    ...
    public static void main(String[] argv) throws IOException, OptimizerException, UpdateableException, EvaluationException, AlignmentException {
        ...
        MeshiWriter appender = new MeshiWriter(outPath+ File.separatorChar+"info."+iMGroup+".csv", true);
            ...
            String modelName="MODEL.pdb";
            //Step1 - Create tmp folder
            String tmp = tmpPath+"Meshi." + Paths.get(inFileName).getFileName().toString()+File.separator;
            ...
            Files.copy(Paths.get(inFileName),Paths.get(tmp+Paths.get(inFileName).getFileName().toString()), StandardCopyOption.REPLACE_EXISTING);
