...
public class SSAlphabetDB implements Callable<Integer> {
    ...
    public static void main(String[] args) throws IOException, OptimizerException, UpdateableException, EvaluationException, Exception {
        ...
        String arg4_native = "-nativeFileName=";
        String arg5_out = "-outFileName=";
        String[] arg = {"-commands=../commands_sidiLocalV2", "-inFileName=QUARK_TS3.pdb", "-dsspFile=QUARK_TS3.dssp", "-nativeFileName=T0755.N.pdb" ,"-outFileName=QUARK_TS3.out.pdb", "-seed=1"};
            ...
            if (listOfFiles[iDir].isDirectory()) {
                ...
                for (int iModel=0;iModel <listOfpdbs.length;iModel++) {//targets
                    ...
                    String[] mainArgs = {commands,arg2_iniFileName+nwd+"pdb\\"+listOfpdbs[iModel].getName(),
                            arg3_dssp+dsspFilePath,arg4_native+nwd+"aux_\\"+listOfFiles[iDir].getName()+".N.pdb","-outFileName="+nwd+listOfpdbs[iModel].getName()+"out.pdb", "-seed=1"};
