 ...
 */
public class SecondaryStructureAlphabetFeatures_plusNoiseCreator extends EnergyCreator{
    MeshiSequence[] SsSequences;

    public SecondaryStructureAlphabetFeatures_plusNoiseCreator() {
    ...
    public AbstractEnergy createEnergyTerm(Protein model, DistanceMatrix dm, CommandList commands) {
        ...
        term =  new SecondaryStructureAlphabetFeatures_plusNoise(model, SsSequences);
        return term;
